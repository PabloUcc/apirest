<?php
    ...
    class pacientes extends conexion{
        ...
        private $correo = "";
        private $token= "";
       // b3b3e2b6fa18ca182a4a13d3e0303306
        ...
        public function post($json){
            ...
            if(!isset($datos['token'])){
                ...
                if($arrayToken){
                    ...
                    return $_respuestas->error_401("El token que envió es inválido o a caducado");
                }
            }
        }

        private function insertarPaciente(){
            $query = "INSERT INTO ". $this->table . "(DNI,Nombre,Telefono,Direccion,CodigoPostal,Genero,FechaNacimiento,Correo)
            values
            ('" .$this->dni . "','" . $this->nombre . "','" . $this->telefono . "','" . $this->direccion . "','" . $this->codigoPostal . "','" . $this->genero . "','" . $this->fechaNacimiento . "','" . $this->correo . "');";
